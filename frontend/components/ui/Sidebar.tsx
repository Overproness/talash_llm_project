  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-[220px] bg-[#1e1b4b] shadow-xl shadow-indigo-950/50 flex flex-col py-6 z-50">
      ...
      <div className="px-6 mb-10 flex items-center gap-2 text-xl font-bold text-white">
        <span className="material-symbols-outlined text-indigo-400">upload</span>
      ...
      <div className="px-4 mt-auto">
        <div className="p-4 rounded-xl bg-white/5 border border-white/10">
          <p className="text-[10px] text-indigo-300 font-bold uppercase mb-1">Smart HR Recruitment</p>
          <p className="text-xs text-white/50 leading-relaxed">Powered by TALASH Intelligence Engine.</p>
        </div>
      </div>
    </aside>
  )
