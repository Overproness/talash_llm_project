        ...
        <div className="pt-24 px-8 pb-12">
          <div className="mb-8">
            ...
            <p className="text-on-surface-variant mt-1 text-sm">
              System configuration and LLM provider
            </p>
          </div>
          ...
          <div className="space-y-6 max-w-2xl">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-2 h-2 rounded-full flex-shrink-0 ${item.ok ? "bg-emerald-400" : "bg-amber-400"}`}
                      />
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {llm &&
                  Object.entries(llm.providers).map(([key, info]) => {
              ...
              {llm && (
                <div className="mb-5">
                  ...
                  >
                    {(
                      llm.providers[selectedProvider]?.models ?? [selectedModel]
                    ).map((m) => (
                    ...
                    {selectedModel &&
                      !llm.providers[selectedProvider]?.models.includes(
                        selectedModel,
                      ) && (
              ...
              <div className="flex items-center gap-4">
                ...
                {saveMsg && (
                  <span
                    className={`text-sm ${saveMsg.ok ? "text-emerald-600" : "text-error"}`}
                  >
            ...
            <div className="bg-surface-container rounded-2xl p-6 border-l-4 border-primary">
              ...
              <p className="text-xs text-outline mt-4 pt-3 border-t border-outline-variant/20">
                Provider switches take effect immediately — no server restart
                needed. When all providers are unavailable, rule-based regex
