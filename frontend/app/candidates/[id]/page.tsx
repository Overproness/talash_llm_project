...
import { CandidateFull, EducationAnalysis } from "@/lib/types";
...
export default function CandidateProfilePage() {
  ...
  const [selectedInstitution, setSelectedInstitution] = useState<
    NonNullable<EducationAnalysis["institution_quality"]>[number] | null
  >(null);
  ...
  return (
    <div className="flex min-h-screen bg-surface">
      ...
      <main className="ml-[220px] flex-1">
                        ...
                        >
                          ...
                          <td className="px-5 py-3 text-on-surface-variant">
                            {(() => {
                              ...
                              const qualityRecord =
                                eduAnalysis?.institution_quality?.find(
                                  (iq) =>
                                    iq.institution === instName ||
                                    iq.matched_name === instName,
                                );
                              ...
                              if (qualityRecord) {
                                return (
                                  <button
                                    onClick={() =>
                                      setSelectedInstitution(qualityRecord)
                                    }
                                    className="text-primary hover:underline underline-offset-2 text-left font-medium"
                                  >
                                    {instName}
                                    <span className="material-symbols-outlined text-xs ml-1 align-middle opacity-60">
                                      info
                                    </span>
                                  </button>
                                );
        ...
        <InstitutionModal item={selectedInstitution}onClose={() => setSelectedInstitution(null)}/>
      </main>
    </div>
  );
}
